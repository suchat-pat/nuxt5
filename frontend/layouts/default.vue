...
const roles = [
    ...
    {title:'รายงานผลการประเมินของผู้รับการประเมิน',to:'/Staff/Score_evaList',role:'ฝ่ายบุคลากร'},
    {title:'รายงานผลการประเมินของกรรมการ',to:'/Staff/Score_commitList',role:'ฝ่ายบุคลากร'},
